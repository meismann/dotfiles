...
alias rd='rubocop $(git diff --name-only $(current_git_repo_base_branch) | grep "\.rb$\|\.rake$")'
alias rda='rubocop -a $(git diff --name-only $(current_git_repo_base_branch) | grep "\.rb$\|\.rake$")'
